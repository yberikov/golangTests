...
func TestValidateDevice(t *testing.T) {
	tests := []struct {
		...
		{
			name:     "Valid Device",
			device:   models.Device{SerialNum: "12345", Model: "Model1", IP: "192.168.1.1"},
			expected: nil,
		},
		{
			name:     "Empty SerialNum",
			device:   models.Device{SerialNum: "", Model: "Model2", IP: "192.168.1.2"},
			expected: fmt.Errorf("field cannot be empty"),
		},
		{
			name:     "Empty Model",
			device:   models.Device{SerialNum: "67890", Model: "", IP: "192.168.1.3"},
			expected: fmt.Errorf("field cannot be empty"),
		},
		{
			name:     "Empty IP",
			device:   models.Device{SerialNum: "54321", Model: "Model3", IP: ""},
			expected: fmt.Errorf("field cannot be empty"),
		},
		{
			name:     "Invalid IP Format",
			device:   models.Device{SerialNum: "13579", Model: "Model4", IP: "invalidip"},
