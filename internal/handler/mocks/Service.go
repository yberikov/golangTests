...
func (_m *Service) CreateDevice(_a0 models.Device) error {
	ret := _m.Called(_a0)
...
func (_m *Service) GetDevice(_a0 string) (models.Device, error) {
	ret := _m.Called(_a0)
...
func (_m *Service) UpdateDevice(_a0 models.Device) error {
	ret := _m.Called(_a0)
