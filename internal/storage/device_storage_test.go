...
func (s *MyTestSuite) SetupTest() {
	...
	s.devices = map[string]models.Device{"1235": {SerialNum: "1235", Model: "HP", IP: "121.121.121.121"},
...
func (s *MyTestSuite) TearDownSuite() {
	...
	s.devices = map[string]models.Device{}
}
...
func (s *MyTestSuite) TestDeviceStorage_CreateDevice() {
	tests := []struct {
		...
		{
			name:   "success",
			device: models.Device{SerialNum: "4444", Model: "KOP", IP: "013.33.121.6"},
			err:    nil,
		},
		{
			name:   "DeviceAlreadyExists",
			device: models.Device{SerialNum: "1235", Model: "HP", IP: "121.121.121.121"},
...
func (s *MyTestSuite) TestDeviceStorage_UpdateDevice() {
	tests := []struct {
		...
		{
			name:   "success",
			device: models.Device{SerialNum: "1235", Model: "ASUS", IP: "1.1.4.44"},
			err:    nil,
		},
		{
			name:   "NoSuchDevice",
